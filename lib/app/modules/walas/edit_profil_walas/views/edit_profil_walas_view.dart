...
class EditProfilWalasView extends GetView<EditProfilWalasController> {
  const EditProfilWalasView({super.key});
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditProfilWalasController());
