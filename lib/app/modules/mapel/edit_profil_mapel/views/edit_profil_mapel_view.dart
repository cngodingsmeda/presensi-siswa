...
class EditProfilMapelView extends GetView<EditProfilMapelController> {
  const EditProfilMapelView({super.key});
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditProfilMapelController());
                      ...
                      Column(
                        children: [
                          ...
                          AllMaterial.editableWidget(
                            ...
                            focusNode: controller.mapelF,
                            label: "Mata Pelajaran Diajar",
                          ),
                          AllMaterial.editableWidget(
