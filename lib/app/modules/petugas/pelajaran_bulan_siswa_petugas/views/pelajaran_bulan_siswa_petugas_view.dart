...
class PelajaranBulanSiswaPetugasView
    extends GetView<PelajaranBulanSiswaPetugasController> {
  const PelajaranBulanSiswaPetugasView({super.key});
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(PelajaranBulanSiswaPetugasController());
