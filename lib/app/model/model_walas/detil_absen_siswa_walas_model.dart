...
//
//     final detilAbsenSiswaWalasModel = detilAbsenSiswaWalasModelFromJson(jsonString);

import 'dart:convert';

DetilAbsenSiswaWalasModel detilAbsenSiswaWalasModelFromJson(String str) =>
    DetilAbsenSiswaWalasModel.fromJson(json.decode(str));

String detilAbsenSiswaWalasModelToJson(DetilAbsenSiswaWalasModel data) =>
    json.encode(data.toJson());

class DetilAbsenSiswaWalasModel {
  String? msg;
  Data? data;

  DetilAbsenSiswaWalasModel({
    this.msg,
    this.data,
  });

  factory DetilAbsenSiswaWalasModel.fromJson(Map<String, dynamic> json) =>
      DetilAbsenSiswaWalasModel(
        msg: json["msg"],
